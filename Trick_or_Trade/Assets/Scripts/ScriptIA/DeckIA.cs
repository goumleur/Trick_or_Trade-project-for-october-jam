...
public class DeckIA : Decks
{
    ...
    {
        main.SetActive(true);
        GameObject.Find("IAHand").GetComponent<Mains>().SauverCarte(carteAChercher);
        Transform discard = GameObject.Find("DeckIA").transform;
        ...
        foreach (Transform enfant in discard)
        {
            ...
            GameObject discardPile = GameObject.Find("DeckIA");
    ...
    override public void PutCarteAVoir()
    {
        ...
        {
            int total = GameObject.Find("DeckIA").transform.childCount;
            ...
            {
                premiers[i] = GameObject.Find("DeckIA").transform.GetChild(i);
            }

            // Les déplacer à la fin
            foreach (Transform enfant in premiers)
            {
                enfant.SetSiblingIndex(GameObject.Find("DeckIA").transform.childCount - 1);
            }
        }
    }
